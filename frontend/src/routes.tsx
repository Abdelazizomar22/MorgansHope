            ...
            <div className="flex min-h-screen items-center justify-center bg-[#F7FAFC]">
              <div className="flex flex-col items-center gap-4">
                <div className="relative h-12 w-12">
                  ...
                  <div className="absolute inset-0 animate-spin rounded-full border-4 border-transparent border-t-[#2E5C5A]" />
                </div>
                <p className="text-sm font-medium tracking-wide text-[#475569]">Loading...</p>
              </div>
            </div>
          )}
        >
